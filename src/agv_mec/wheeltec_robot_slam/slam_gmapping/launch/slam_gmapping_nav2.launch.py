...
def generate_launch_description():
    ...
    # nav2_bringup_dir = get_package_share_directory('wheeltec_nav2')
    # nav2_launch_dir = os.path.join(nav2_bringup_dir, 'launch')
    # wheeltec_nav2 = IncludeLaunchDescription(
    #         PythonLaunchDescriptionSource(os.path.join(nav2_launch_dir, 'wheeltec_nav2_for_slam.launch.py')),
    # )
