...
# 下载并创建 AGV Qwen2.5 0.5B-FC 模型
wget -c https://archive.spacemit.com/spacemit-ai/gguf/qwen2.5-0.5b-f16-agv-fc-Q4_0.gguf --no-check-certificate
wget -c https://archive.spacemit.com/spacemit-ai/modelfile/qwen2.5-0.5b-agv-fc.modelfile --no-check-certificate
ollama create qwen2.5-0.5b-agv-fc -f qwen2.5-0.5b-agv-fc.modelfile
