...
def generate_launch_description():
    ...
    #     map_dir, 'spacemit1.yaml'))
    map_file = LaunchConfiguration('map', default=os.path.join(
        # map_dir, 'spacemit0520.yaml'))
        map_dir, 'spacemit0522.yaml'))
    ...
    #MPPI:wheeltec_akm_mppi_demo.yaml wheeltec_mec_mppi_demo.yaml wheeltec_diff_mppi_demo.yaml
    param_dir = os.path.join(wheeltec_nav_dir, 'param','wheeltec_param')
    # param_file = LaunchConfiguration('params', default=os.path.join(param_dir, 'param_mini_mec.yaml'))
    param_file = LaunchConfiguration('params', default=os.path.join(param_dir, 'param_mini_mec_follow_point.yaml'))

    # param_file = LaunchConfiguration('params', default=os.path.join(param_dir, 'param_mini_mec_dev.yaml'))
